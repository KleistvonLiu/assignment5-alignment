"""
uv run python scripts/evaluate_math_baseline.py --model-name-or-path outputs/sft_mathv2_filtered_data/final_model/ --validation-path data/MATHv2/validation.jsonl --output-dir ./outputs/sft_full_mathv2_eval_correct_only
"""
...
def evaluate_vllm(
    ...
    """Evaluate a language model on prompts and serialize per-example results."""
